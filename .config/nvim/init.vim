...
Plug 'tpope/vim-surround'  " Quoting mappings see ':help surround'
Plug 'tpope/vim-unimpaired'  " Adds a bunch of bracket mappings see ':help unimpaired'
Plug 'tpope/vim-commentary'  " Comment with gcc
Plug 'tpope/vim-repeat'  " . works with more stuff
Plug 'tpope/vim-sleuth'  " Adapt tab size based on file and context
Plug 'tpope/vim-sensible'  " Some sane defaults
Plug 'michaeljsmith/vim-indent-object'  " Adds indentation based objects see ':help indent-object'
Plug 'mg979/vim-visual-multi', {'branch': 'master'}  " Multiple curors like VS-code/Sublime ':help visual-multi'
...
" Source vim config when updated.
autocmd! BufWritePost $MYVIMRC source $MYVIMRC

" Update bspwm when bspwmrc is updated.
autocmd BufWritePost *bspwmrc !./%

" Update binds when sxhkdrc is updated.
autocmd BufWritePost *sxhkdrc !pkill -USR1 sxhkd

" Reload polybar when config is updated.
